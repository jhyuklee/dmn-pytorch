...
argparser.add_argument('--e_rnn_ln', type=int, default=1)
argparser.add_argument('--e_rnn_dr', type=float, default=0.5)
argparser.add_argument('--a_rnn_hdim', type=int, default=200)
argparser.add_argument('--a_rnn_ln', type=int, default=1)
argparser.add_argument('--a_rnn_dr', type=float, default=0.5)
